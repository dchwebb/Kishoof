...
private:
	...
	static constexpr std::string_view USBD_PRODUCT_STRING = "Mountjoy Kishoof Test";
	static constexpr std::string_view USBD_CFG_STRING = "Mountjoy Kishoof Test Config";
	static constexpr std::string_view USBD_MSC_STRING = "Mountjoy Kishoof Test Storage";
	static constexpr std::string_view USBD_CDC_STRING = "Mountjoy Kishoof Test Serial";
	static constexpr std::string_view USBD_MIDI_STRING	= "Mountjoy Kishoof Test MIDI";
	...
	std::array<USBHandler*, 3>classesByInterface;		// Lookup tables to get appropriate class handlers (set in handler constructor)
	...
	static constexpr uint16_t ProductId = 65440;
