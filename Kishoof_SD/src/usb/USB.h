...
private:
	...
	static constexpr std::string_view USBD_PRODUCT_STRING = "Mountjoy Kishoof SD";
	static constexpr std::string_view USBD_CFG_STRING = "Mountjoy Kishoof SD Config";
	static constexpr std::string_view USBD_MSC_STRING = "Mountjoy Kishoof SD Storage";
	static constexpr std::string_view USBD_CDC_STRING = "Mountjoy Kishoof SD Serial";
	static constexpr std::string_view USBD_MIDI_STRING	= "Mountjoy Kishoof SD MIDI";
	...
	static constexpr uint16_t ProductId = 65441;
